 ...
 */
export const testVaultConnection = <ThrowOnError extends boolean = false>(options?: Options<TestVaultConnectionData, ThrowOnError>) => (options?.client ?? client).post<TestVaultConnectionResponses, TestVaultConnectionErrors, ThrowOnError>({ url: '/api/secrets/test-vault-connection', ...options });
