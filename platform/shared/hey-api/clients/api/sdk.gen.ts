 ...
 */
export const getMcpRateLimits = <ThrowOnError extends boolean = false>(options?: Options<GetMcpRateLimitsData, ThrowOnError>) => (options?.client ?? client).get<GetMcpRateLimitsResponses, GetMcpRateLimitsErrors, ThrowOnError>({ url: '/api/mcp-rate-limits', ...options });

/**
 * Create a new MCP rate limit
 */
export const createMcpRateLimit = <ThrowOnError extends boolean = false>(options: Options<CreateMcpRateLimitData, ThrowOnError>) => (options.client ?? client).post<CreateMcpRateLimitResponses, CreateMcpRateLimitErrors, ThrowOnError>({
...
/**
 * Delete an MCP rate limit
 */
export const deleteMcpRateLimit = <ThrowOnError extends boolean = false>(options: Options<DeleteMcpRateLimitData, ThrowOnError>) => (options.client ?? client).delete<DeleteMcpRateLimitResponses, DeleteMcpRateLimitErrors, ThrowOnError>({ url: '/api/mcp-rate-limits/{id}', ...options });

/**
 * Get an MCP rate limit by ID
 */
export const getMcpRateLimit = <ThrowOnError extends boolean = false>(options: Options<GetMcpRateLimitData, ThrowOnError>) => (options.client ?? client).get<GetMcpRateLimitResponses, GetMcpRateLimitErrors, ThrowOnError>({ url: '/api/mcp-rate-limits/{id}', ...options });

/**
 * Update an MCP rate limit
 */
export const updateMcpRateLimit = <ThrowOnError extends boolean = false>(options: Options<UpdateMcpRateLimitData, ThrowOnError>) => (options.client ?? client).patch<UpdateMcpRateLimitResponses, UpdateMcpRateLimitErrors, ThrowOnError>({
